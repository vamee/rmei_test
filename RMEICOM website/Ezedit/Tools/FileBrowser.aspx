<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FileBrowser.aspx.vb" Inherits="Ezedit_Tools_FileBrowser"
    EnableEventValidation="false" Title="File Browser" %>
                                    ...
                                    <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                        <tr>
                                            ...
                                            <td align="center" width="20">
                                                <asp:HyperLink ID="hypPreview" runat="server" Visible="false" Target="_blank" ImageUrl="~/App_Themes/EzEdit/Images/magnifier_zoom_in.png" />
                                            </td>
                                        </tr>
                                    </table>
                                </ItemTemplate>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <VAM:RequiredTextValidator ID="RequiredTextValidator1" runat="server" ControlIDToEvaluate="uplFileName"
                                                SummaryErrorMessage="Please choose a file to upload." />
                                            <VAM:CompareToStringsValidator ID="CompareToStringsValidator1" runat="server" ControlIDToEvaluate="uplFileName"
                                                MatchTextRule="EndsWith" CaseInsensitive="true" Enabled="false">
