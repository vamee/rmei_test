<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FileBrowser.aspx.vb"
    Inherits="Ezedit_Modules_FileBrowser" EnableEventValidation="false"
    Title="File Browser" %>
...
<body style="background-color: #D2CEC2;">
    ...
    <div>
        ...
        <asp:Label ID="lblCurrentDirectory" runat="server" CssClass="main" Width="240" BorderStyle="Solid"
        ...
        <radTS:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0" Width="360" AutoScrollBars="true">
            <radTS:PageView ID="pvBrowse" runat="server" Width="100%" >
                <asp:GridView ID="gdvFileNames" runat="server" AutoGenerateColumns="false" Width="98%"
