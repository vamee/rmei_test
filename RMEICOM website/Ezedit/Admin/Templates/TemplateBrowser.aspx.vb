...
Partial Class Ezedit_Admin_Templates_TemplateBrowser
    Inherits System.Web.UI.Page

    Dim RootPath As String = Server.MapPath(GlobalVariables.GetValue("VirtualTemplateUploadPath"))
    ...
    Function GetDataTable(ByVal strPath As String) As DataTable
        ...
        Dim FileList() As String = Directory.GetFiles(strPath, "*.master*")
    ...
    Protected Sub gdvFileNames_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gdvFileNames.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            ElseIf ItemType = "File" Then
                ...
                If Emagine.GetFileExtension(ItemPath) = ".master" Then
