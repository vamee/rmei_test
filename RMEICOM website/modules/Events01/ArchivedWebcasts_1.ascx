<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ArchivedWebcasts_1.ascx.vb" Inherits="Events01_CurrentWebcasts_1" %>
...
<ItemTemplate>
    <tr class='table-row'>
      ...
      <td align="right"><asp:HyperLink ID="hypRegister" runat="server" CssClass="main" Text="Download"></asp:HyperLink></td>
    </tr>
    <tr class='table-row'>
...
<asp:Label ID="lblEventInfo" runat="server" CssClass="main"></asp:Label>