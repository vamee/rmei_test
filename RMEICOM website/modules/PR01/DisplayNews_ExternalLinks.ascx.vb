...
Partial Class PR01_DisplayNews_ExternalLinks
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim ModuleCategory As ModuleCategory = ModuleCategory.GetModuleCategory(CategoryID)
        ...
        Else
            lblCategoryName.Text = ModuleCategory.CategoryName
            If ModuleCategory.PublishToRss Then
                hypRss.NavigateUrl = "/" & ModuleCategory.CategoryID & "/rss.htm"
                hypRss.Visible = True
            End If
